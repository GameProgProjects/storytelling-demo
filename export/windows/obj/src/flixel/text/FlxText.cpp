...
HXLINE( 651)		this->_defaultFormat->set_size(Size);
HXLINE( 652)		{
...
HXLINE( 704)			this->_defaultFormat->set_font(newFontName);
            		}
            		else {
HXLINE( 708)			this->_defaultFormat->set_font(::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT);
            		}
HXLINE( 711)		{
...
HXLINE( 728)		this->_defaultFormat->set_font(Font);
HXLINE( 729)		{
...
HXLINE( 742)			this->_defaultFormat->set_bold(value);
HXLINE( 743)			{
...
HXLINE( 757)			this->_defaultFormat->set_italic(value);
HXLINE( 758)			{
...
HXLINE(1254)		to->set_font(from->font);
HXLINE(1255)		to->set_bold(from->bold);
HXLINE(1256)		to->set_italic(from->italic);
HXLINE(1257)		to->underline = from->underline;
HXLINE(1258)		to->set_size(from->size);
